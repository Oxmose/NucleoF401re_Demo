...
OBJECTS += Menu/Menu.o
OBJECTS += MenuAction/MenuActionExecFunc.o
OBJECTS += MenuAction/MenuActionFlowPatterns.o
OBJECTS += MenuAction/MenuActionIndividualLeds.o
OBJECTS += MenuAction/MenuActionLed.o
OBJECTS += MenuAction/MenuActionLedFlow.o
OBJECTS += MenuAction/MenuActionRGBLed.o
OBJECTS += MenuAction/MenuActionRGBManager.o
OBJECTS += MenuAction/MenuActionSensors.o
OBJECTS += RGBLed/RGBLed.o
OBJECTS += Screen/OLEDScreen.o
OBJECTS += Sensor/LumSensor.o
OBJECTS += main.o
...
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE/system_stm32f4xx.o
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device/TOOLCHAIN_GCC_ARM/startup_stm32f401xe.o
OBJECTS += mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device/cmsis_nvic.o
...
INCLUDE_PATHS += -I../Menu
INCLUDE_PATHS += -I../MenuAction
INCLUDE_PATHS += -I../RGBLed
INCLUDE_PATHS += -I../Screen
...
INCLUDE_PATHS += -I../mbed-os/targets/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device/TOOLCHAIN_GCC_ARM
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1493837907.7
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1493837907.7
